                        ...
                        <div class="card-body">
                            <form action="{{ route('validation.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="job_category_id" class="col-md-4 col-form-label text-right">Job
                                        Category</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="work_experience"
                                                id="experience_yes" value="1" {{ old('work_experience') == '1' ? 'checked' : '' }} required>
                                            <label class="form-check-label" for="experience_yes">Yes, I have</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="work_experience"
                                                id="experience_no" value="0" {{ old('work_experience') == '0' ? 'checked' : '' }}>
                                ...
                                <!-- Job Position -->
                                <div class="form-group row">
                                    <label for="job_position" class="col-md-4 col-form-label text-right">Job
                                        Position</label>
                                    <div class="col-md-8">
                                        <textarea name="job_position" id="job_position" rows="2" class="form-control"
                                            placeholder="e.g. Web Developer, UI Designer"
                                            required>{{ old('job_position') }}</textarea>
                                ...
                                <!-- Reason Accepted -->
                                <div class="form-group row">
                                    <label for="reason_accepted" class="col-md-4 col-form-label text-right">Reason
                                        Accepted</label>
                                    <div class="col-md-8">
                                        <textarea name="reason_accepted" id="reason_accepted" rows="4" class="form-control"
                                            placeholder="Explain why you should be accepted"
                                            required>{{ old('reason_accepted') }}</textarea>
